    ...
    pub fn buffer_layout() -> wgpu::VertexBufferLayout<'static> {
        ...
        wgpu::VertexBufferLayout {
            ...
            attributes: &[
                ...
                // loc 4: anchor (xy)
                wgpu::VertexAttribute { offset:  28, shader_location:  4, format: wgpu::VertexFormat::Float32x2 },
                // loc 5: color (rgba)
                ...
                wgpu::VertexAttribute { offset:  52, shader_location:  6, format: wgpu::VertexFormat::Float32x2 },
                // loc 7: uv_offset.xy + uv_scale.xy  (packed — contiguous bytes 60–76)
                wgpu::VertexAttribute { offset:  60, shader_location:  7, format: wgpu::VertexFormat::Float32x4 },
                // loc 8: atlas_page (u32)
                wgpu::VertexAttribute { offset:  76, shader_location:  8, format: wgpu::VertexFormat::Uint32    },
                ...
                wgpu::VertexAttribute { offset:  96, shader_location: 10, format: wgpu::VertexFormat::Float32x2 },
                // loc 11: border_color (rgba)
                wgpu::VertexAttribute { offset: 104, shader_location: 11, format: wgpu::VertexFormat::Float32x4 },
                // loc 12: border_offset
                wgpu::VertexAttribute { offset: 120, shader_location: 12, format: wgpu::VertexFormat::Float32   },
            ],
        }
    }
}
